...
public class MatchHandler {
    ...
    public MatchHandler(UserDao userDao) {
    ...
    public String handleInviteAccept(ClientHandler inviteeClient, String[] parts) {
        try {
            ...
            activeMatches.put(matchId, new HashMap<>());
    ...
    public String handleMatchEnd(ClientHandler client, String[] parts) {
        try {
            ...
            // Chỉ cleanup và broadcast AVAILABLE khi CẢ 2 người chơi đã confirm
            ...
            if (bothPlayersConfirmed || opponentUsername == null) {
                ...
                // Broadcast AVAILABLE cho cả 2 người chơi
                broadcastUserStatus(username, "AVAILABLE");
                if (opponentUsername != null) {
                    broadcastUserStatus(opponentUsername, "AVAILABLE");
                }
            } else {
